 ...
 */
public final class JunoRestClientBuilder {
    /**
    ...
    private JunoRestClient.FailureListener failureListener;
     ...
     */
    JunoRestClientBuilder(List<Node> nodes) {
     ...
     */
    public JunoRestClientBuilder setDefaultHeaders(Header[] defaultHeaders) {
     ...
     */
    public JunoRestClientBuilder setFailureListener(RestClient.FailureListener failureListener) {
     ...
     */
    public JunoRestClientBuilder setHttpClientConfigCallback(HttpClientConfigCallback httpClientConfigCallback) {
     ...
     */
    public JunoRestClientBuilder setRequestConfigCallback(RequestConfigCallback requestConfigCallback) {
     ...
     */
    public JunoRestClientBuilder setPathPrefix(String pathPrefix) {
     ...
     */
    public JunoRestClientBuilder setNodeSelector(NodeSelector nodeSelector) {
     ...
     */
    public JunoRestClientBuilder setStrictDeprecationMode(boolean strictDeprecationMode) {
     ...
     */
    public JunoRestClientBuilder setCompressionEnabled(boolean compressionEnabled) {
     ...
     */
    public JunoRestClientBuilder setChunkedEnabled(boolean chunkedEnabled) {
     ...
     */
    public JunoRestClient build() {
        if (failureListener == null) {
            failureListener = new JunoRestClient.FailureListener();
        }
        ...
        JunoRestClient restClient = null;

        if (chunkedEnabled.isPresent()) {
            restClient = new JunoRestClient(
                httpClient,
                defaultHeaders,
                nodes,
                pathPrefix,
